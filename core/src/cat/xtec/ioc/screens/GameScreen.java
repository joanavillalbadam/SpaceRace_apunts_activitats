...
public class GameScreen implements Screen {
   ...
   // private ScrollGasoil gasoil;
    ...
    private void drawElements() {
        ...
        // Pintem la nau
       // shapeRenderer.rect(gasoil.getX(),gasoil.getY(),gasoil.getWidth(),gasoil.getHeight());
    ...
    private void updateRunning(float delta) {
        ...
        if(scrollHandler.collides2(bala)){
            //AssetManager.explosionSound.play();
            stage.getRoot().findActor("bala").remove();
            Gdx.app.log ("coordenada Medio has clickado en" ,null);
            textLayout.setText(AssetManager.font, "puntos: "+cadena);
    ...
    public void reset() {
        ...
        stage.addActor(spacecraft);
        //posem el contador de puntuacio a 0
        puntos = 0;
